...
export const WorkshopNavbar: React.FC<WorkshopNavbarProps> = ({
  ...
  return (
    <>
      ...
      <nav
        className={twMerge(
          "fixed top-0 -z-10 h-full w-full items-center justify-center bg-black py-6 opacity-0 shadow-md shadow-[#374151] transition-all duration-300 ease-in-out lg:sticky lg:top-[95px] lg:z-20 lg:flex lg:h-fit lg:translate-x-0 lg:opacity-100",
